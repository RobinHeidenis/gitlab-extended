...
const createEmojiSvg = () => {
  ...
  emojiSvg.setAttribute("enable-background", "new 0 0 512 512");
  emojiSvg.setAttribute("viewBox", "0 0 512 512");
  emojiSvg.setAttributeNS(
    "http://www.w3.org/2000/xmlns/",
    "xmlns:xlink",
    "http://www.w3.org/1999/xlink",
  );
  emojiSvg.setAttribute("height", "12");
  emojiSvg.setAttribute("width", "12");

  const emojiPath = document.createElementNS(
    "http://www.w3.org/2000/svg",
    "path",
  );
